...
function () {
  ...
  _createClass(Difference, [{
    ...
    key: "bindTriggers",
    value: function bindTriggers(contaiter, items, counter) {
      contaiter.querySelector('.plus').addEventListener('click', function () {
...
function () {
  ...
  _createClass(Forms, [{
    key: "noCyrillicInputValidation",
    value: function noCyrillicInputValidation(selector) {
    ...
    value: function removeStatusMessage() {
      document.querySelectorAll('.status-message').forEach(function (item) {
        return item.remove();
      });
    }
  }, {
    key: "changeStatusMessage",
    value: function changeStatusMessage(text, num) {
      this.forms[num].querySelector('.status-message').textContent = text;
    }
  }, {
    key: "postData",
    value: function postData(url, data, num) {
      var message, res;
    ...
    value: function bindTriggers() {
      ...
      this.forms.forEach(function (form, i) {
        form.addEventListener('submit', function _callee(e) {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 5;
                  return regeneratorRuntime.awrap(_this.postData(_this.path, formData, i));
                ...
                case 8:
                  ...
                  _this.changeStatusMessage(_this.messages.success, i);
                ...
                case 13:
                  ...
                  _this.changeStatusMessage(_this.messages.failur, i);
                ...
                case 16:
                  ...
                  setTimeout(_this.removeStatusMessage, 5000);
          ...
          }, null, null, [[0, 13, 16, 20]]);
        });
      });
    }
  }, {
    key: "cratePhoneMask",
    value: function cratePhoneMask(selector) {
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        if (active.getAttribute('type') == "button") {
          active = _this2.slides[_this2.slides.length - 3];
        }
    ...
    key: "bindTriggersForAutoplay",
    value: function bindTriggersForAutoplay() {
      var _this3 = this;
      ...
      var freezeAutoplayForElem = function freezeAutoplayForElem(elem) {
